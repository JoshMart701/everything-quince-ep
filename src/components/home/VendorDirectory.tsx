...
// Sample vendor data for homepage preview — slugs map to real seeded vendors
const SAMPLE_VENDORS = [
  {
    ...
    plan: "pro",
    isFeature: false,
    description: "Cinematic photo & video packages with drone footage included.",
    logo: "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?w=100&h=100&fit=crop&q=80",
  },
  {
    id: "2",
    slug: "el-paso-grand-events-hall",
    businessName: "El Paso Grand Events Hall",
    category: "venues",
    city: "El Paso",
    rating: 4.9,
    reviewCount: 47,
  ...
  },
  {
    ...
    plan: "premium",
    isFeature: false,
    description: "400+ quinceañeras, bilingual MC, LED dance floor & custom lighting.",
    logo: "https://images.unsplash.com/photo-1522673607200-164d1b6ce486?w=100&h=100&fit=crop&q=80",
  },
  {
    id: "5",
    slug: "sabor-del-pueblo-catering",
    businessName: "Sabor del Pueblo Catering",
    category: "catering",
    city: "El Paso",
    rating: 4.9,
    reviewCount: 134,
  ...
  },
  {
    ...
    plan: "pro",
    isFeature: false,
    description: "Full venue transformations: florals, arches, centerpieces & balloon walls.",
    logo: "https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?w=100&h=100&fit=crop&q=80",
  },
];
